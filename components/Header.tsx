...
export const Header: React.FC = () => {
  return (
    <header className="w-full py-8 text-center relative overflow-hidden">
      ...
      <h1 className="text-4xl md:text-6xl font-serif italic font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-blue via-white to-neon-purple mb-2">
        Soul Spirits
      </h1>
